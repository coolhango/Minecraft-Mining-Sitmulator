...
while True:
    ...
    if movingRight and x<600 and canMoveRight:
        x+=3
    gameDisplay.blit(font.render('Backpack: %d/%d'%(stuffInBackpack,backpackCapacity[equippedBackpack]),False,(255,255,255)),(640-font.render('Backpack: %d/%d'%(stuffInBackpack,backpackCapacity[equippedBackpack]),False,(255,255,255)).get_width(),10))
    sellButton=font.render('Sell Ores',False,(255,255,255)).get_rect(topleft=(550,30))
    if mouserect.colliderect(sellButton):
        gameDisplay.blit(font.render('Sell Ores',False,(255,0,0)),(550,30))
    else:
        gameDisplay.blit(font.render('Sell Ores',False,(255,255,255)),(550,30))
    surfaceButton=font.render('To Surface',False,(255,255,255)).get_rect(topleft=(535,70))
    if mouserect.colliderect(surfaceButton):
        gameDisplay.blit(font.render('To Surface',False,(255,0,0)),(535,70))
    else:
        gameDisplay.blit(font.render('To Surface',False,(255,255,255)),(535,70))
    shopButton=font.render('Shop',False,(255,255,255)).get_rect(topleft=(588,50))
    if mouserect.colliderect(shopButton):
        gameDisplay.blit(font.render('Shop',False,(255,0,0)),(588,50))
    else:
        gameDisplay.blit(font.render('Shop',False,(255,255,255)),(588,50))
    gameDisplay.blit(font.render('Money: $%d'%money,False,(255,255,255)),(10,10))
    if y<222:
        for i in blocks:
            i.y+=1
        y+=1
    gameDisplay.blit(font.render('Depth: %d'%playerDepth,False,(255,255,255)),(10,620))
